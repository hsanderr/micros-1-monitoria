...
unsigned char display_mode[10] = {0b00111111,  // mostra zero no display
                                  ...
                                  0b11001111,  // mostra tres no display
...
int reload_timer = 0;                  // indica se o timer 0 deve ser recarregado
...
void main()
{
  ...
  T0CON = 0x86;   // timer 0 no modo 16 bits e presclaer 1:128
